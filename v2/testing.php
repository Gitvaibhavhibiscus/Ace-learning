            ...
            <div class="row justify-content-between gy-5">
               <div class="col-lg-6 d-flex flex-column justify-content-center">
                  ...
                  <div class="d-flex">
                     ...
                     <img src="assets/img/aapc-logo.svg" alt="" style="
                        padding-left: 15px;">
                  </div>
               ...
               <div class="col-lg-6 form-fixed order-1 order-lg-2 text-center text-lg-start">
         ...
         <div class="container">
            <div class="row gy-3">
               ...
               <div class="col-lg-6 col-md-6 footer-links d-flex">
                  <div>
                     <span><img src="assets/img/location.svg"></span> Sector-136 Noida, UP
                  </div>
               </div>
            </div>
         </div>
